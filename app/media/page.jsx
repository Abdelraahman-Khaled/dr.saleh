...
const MediaAppearances = () => {
    ...
    const t = translations.mediaPage[language];
    ...
    return (
        <div className={`media-appearances-page ${isAr ? 'rtl' : 'ltr'}`}>
            <HeroSection
                title={t.hero.title}
                number="4"
            />
            ...
            <div className="page-video-gallery ptb-100 bg-f4f9fd">
                <div className="container">
                    <div className="section-title">
                        <span className="sub-title">{t.gallery.title}</span>
                        <h2>{t.gallery.subTitle}</h2>
                        <p>{t.gallery.desc}</p>
                    </div>

                    <div className="row justify-content-center">
                        {t.gallery.videos.map((video, index) => (
